...
const BATCH = [
  ...
  ['11.Pathology', 'Pathology', `${BASE}/11.Pathology.pdf`],
  ['14.Medicine', 'Medicine', `${BASE}/14.Medicine.pdf`],
  ['15.Surgery', 'Surgery', `${BASE}/15.Surgery.pdf`],
  ['16.ObsGynae', 'Obstetrics & Gynaecology', `${BASE}/16.ObsGynae.pdf`],
];
