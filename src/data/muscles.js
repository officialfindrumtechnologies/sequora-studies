...
export const MUSCLES = [
  // ==================== SHOULDER ====================
  {
    ...
    questions: [
      ...
      { q: 'Mention the origin, nerve supply and action of Deltoid muscle. Why doctor chose this muscle for intramuscular injection?', a: 'Origin: clavicular head from the lateral 1/3 of the clavicle, acromial head from the acromion, spinal head from the spine of the scapula. Nerve supply: axillary nerve (C5, C6). Action: the middle fibres abduct the arm (15°–90°), the anterior fibres flex and medially rotate, and the posterior fibres extend and laterally rotate the shoulder. Deltoid (specifically its thick middle third, the ventrogluteal-equivalent site on the arm) is chosen for intramuscular injection because it is a large, superficial muscle bulk that is easy to access without disrobing, has a good blood supply for drug absorption, and — if the injection is placed correctly in the mid-lateral part 2–3 finger-breadths below the acromion — it avoids the axillary nerve and posterior circumflex humeral vessels that run along the surgical neck of the humerus below.', source: '1st Prof Anatomy Paper-II, May 2024' }
    ]
  },
  {
    id: 'supraspinatus',
  ...
  // ==================== ARM ====================
  {
    ...
    questions: [
      ...
      { q: 'Why Biceps brachii is synergistic to elbow flexion?', a: 'Brachialis, not biceps brachii, is the true prime mover of elbow flexion because it inserts on the ulna and flexes with equal strength in any forearm position. Biceps brachii is called synergistic (an assisting mover) rather than a prime mover because its main and strongest action is supination of the forearm — its contribution to flexion becomes significant chiefly when the elbow is flexed with the forearm supinated, working alongside brachialis rather than driving flexion independently of forearm position.', source: 'May 2024 (New Curriculum)' }
    ]
  },
  {
    id: 'brachialis',
    ...
    questions: [
      ...
      { q: 'Brachialis muscle causes flexion of the elbow joint — explain.', a: 'Brachialis arises from the distal half of the anterior humerus and inserts on the coronoid process and tuberosity of the ulna, so it crosses only the elbow joint (not the shoulder) directly in front of its axis of rotation. Because it inserts on the ulna, which does not rotate with pronation/supination, its flexor pull is unaffected by forearm position, making it the main flexor of the elbow in every position — earning it the name "workhorse of elbow flexion," acting even when biceps brachii is mechanically disadvantaged.', source: 'Nov 2023 (Old Curriculum)' }
    ]
  },
  {
    id: 'triceps_brachii',
  ...
  // ==================== FOREARM — FLEXORS ====================
  {
    ...
    questions: [
      ...
      { q: 'Define supination and pronation. Mention the name of the muscles causes supination and pronation with their nerve supply.', a: 'Supination is the rotational movement of the forearm that turns the palm to face anteriorly/upward (radius rolls back to lie parallel with the ulna). Pronation is the opposite rotation, turning the palm to face posteriorly/downward (radius crosses over the ulna). Supinators: supinator muscle (deep branch of the radial nerve / posterior interosseous nerve, C7-C8) supinates unopposed, and biceps brachii (musculocutaneous nerve, C5-C6) adds power when supination is resisted, especially with the elbow flexed. Pronators: pronator teres (median nerve, C6-C7) and pronator quadratus (anterior interosseous branch of the median nerve, C8-T1), with pronator quadratus acting as the prime mover and pronator teres assisting, particularly against resistance.', source: 'Nov 2025 (New Curriculum)' }
    ]
  },
  {
  ...
  // ==================== GLUTEAL ====================
  {
    ...
    questions: [
      ...
      { q: 'Write down the origin, insertion, nerve supply and action of gluteus maximus muscle. Why I/M injection is given in upper and outer quadrant of gluteus maximus.', a: 'Origin: posterior gluteal line of the ilium, posterior surfaces of the sacrum and coccyx, and the sacrotuberous ligament. Insertion: mostly into the iliotibial tract, with a deeper part into the gluteal tuberosity of the femur. Nerve supply: inferior gluteal nerve (L5, S1, S2). Action: powerful extension and lateral rotation of the hip, with the upper fibres also assisting abduction — recruited chiefly for forceful hip extension (climbing, rising from sitting, running) rather than level walking. The upper and outer quadrant is chosen for intramuscular injection because the sciatic nerve and the main gluteal neurovascular structures run through the lower and medial parts of the buttock (emerging below/around piriformis), so injecting here reaches thick, safe muscle bulk while avoiding injury to the sciatic nerve, which would otherwise cause foot drop and sensory loss.', source: 'May 2023 (New Curriculum)' }
    ]
  },
  {
    id: 'gluteus_medius',
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'Quadriceps femoris muscle causes extension of the knee Joint — explain.', a: 'Quadriceps femoris is made of four heads — rectus femoris, vastus lateralis, vastus medialis and vastus intermedius — that all converge into a common quadriceps tendon enclosing the patella and continuing as the patellar ligament to the tibial tuberosity. Because every head ultimately inserts via this tendon onto the tibia, contraction of any/all of them pulls the tibia forward relative to the femur, straightening (extending) the knee. Rectus femoris additionally crosses the hip and flexes it, but all four heads act together as the sole major extensor group of the knee, with the patella acting as a sesamoid bone that improves their mechanical leverage.', source: 'May 2024 (Old Curriculum)' }
    ]
  },
  {
    id: 'vastus_lateralis',
  ...
  // ==================== THIGH — POSTERIOR (HAMSTRINGS) ====================
  {
    ...
    questions: [
      ...
      { q: 'Write the origin, insertion, nerve supply & action of hamstring group of muscles.', a: 'Biceps femoris — origin: long head from the ischial tuberosity, short head from the linea aspera and lateral supracondylar line of the femur; insertion: head of the fibula; nerve supply: long head by the tibial division, short head by the common fibular division of the sciatic nerve (L5, S1, S2); action: flexes the knee, extends the hip (long head), and laterally rotates the flexed knee. Semitendinosus — origin: ischial tuberosity; insertion: superomedial surface of the tibia (pes anserinus); nerve supply: tibial division of the sciatic nerve (L5, S1, S2); action: flexes the knee, extends the hip, medially rotates the flexed knee. Semimembranosus — origin: ischial tuberosity; insertion: medial condyle of the tibia (posterior surface); nerve supply: tibial division of the sciatic nerve (L5, S1, S2); action: flexes the knee, extends the hip, medially rotates the flexed knee, and its expansions reinforce the posteromedial knee capsule via the oblique popliteal ligament.', source: 'Nov 2022 (Supplementary)' }
    ]
  },
  {
    id: 'semitendinosus',
  ...
  // ==================== LEG — ANTERIOR (deep fibular nerve) ====================
  {
    ...
    questions: [
      ...
      { q: 'Name the muscles of anterior and lateral compartment of leg with their nerve supply and chief action in a tabulated form.', a: 'Anterior compartment (deep fibular nerve, L4-S1): Tibialis anterior — dorsiflexion + inversion of the foot. Extensor hallucis longus — extension of the great toe + dorsiflexion. Extensor digitorum longus — extension of the lateral 4 toes + dorsiflexion. Fibularis (peroneus) tertius — dorsiflexion + eversion. Lateral compartment (superficial fibular nerve, L5-S1): Fibularis (peroneus) longus — eversion of the foot + support of the transverse and lateral longitudinal arches. Fibularis (peroneus) brevis — eversion of the foot. All anterior compartment muscles share the deep fibular nerve, while both lateral compartment muscles share the superficial fibular nerve — a key distinguishing exam point.', source: 'Nov 2020' }
    ]
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      { q: 'Write the origin, insertion, nerve supply and action of the popliteus muscle.', a: 'Origin: lateral condyle of the femur and the lateral meniscus. Insertion: posterior surface of the tibia, above the soleal line. Nerve supply: tibial nerve (L4, L5, S1). Action: unlocks the fully extended (screw-home locked) knee by laterally rotating the femur on the fixed tibia — or medially rotating the tibia on the fixed femur — so that flexion can begin; it also provides weak knee flexion and retracts the lateral meniscus posteriorly during flexion, protecting it from being crushed.', source: 'May 2025 (New Curriculum)' }
    ]
  },
  {
  ...
  // ==================== THORAX — WALL ====================
  {
    ...
    questions: [
      ...
      { q: 'Write down the origin, insertion, nerve supply and actions of External intercostal muscle of a typical intercostal space.', a: 'Origin: inferior border of the rib above (one muscle occupies each of the 11 intercostal spaces). Insertion: superior border of the rib below, fibres running obliquely downward and medially ("hands in pockets"). Nerve supply: the corresponding intercostal nerve (anterior ramus of the same-numbered thoracic spinal nerve, T1–T11). Action: elevates the ribs during inspiration, increasing the anteroposterior and transverse diameters of the thoracic cavity — the principal muscle of quiet and forced inspiration alongside the diaphragm.', source: 'May 2023 (Old Curriculum)' }
    ]
  },
  {
